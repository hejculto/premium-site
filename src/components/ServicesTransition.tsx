...
export function ServicesTransition() {
  ...
  return (
    <section className="py-16 md:py-20 lg:py-24 bg-black overflow-hidden">
      <div className="container-premium px-6">
        <div className="flex flex-col md:flex-row items-center justify-center text-center md:text-left gap-2 md:gap-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-white">
            We build
          </h2>
          <div className="h-[1.2em] flex items-center justify-center md:justify-start overflow-hidden">
